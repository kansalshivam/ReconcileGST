...
target_file = r'c:\Users\nnipu\Downloads\ReconcileGST\stage_0_artifacts\11_structured_brief.md'

content = r"""# Master Structured Brief — Stage 0 Final Synthesis (ReconcileGST)
...
print(f"Successfully generated exhaustive 11_structured_brief.md ({len(content)} chars)")
